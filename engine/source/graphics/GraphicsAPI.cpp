...
/*Notations for me Lucão,
    ShaderProgram tells openGL how to shade pixels
    Material stores the shader and any uniform values
    Mesh holds the actual geometry to draw
    Graphics API manages unified access to thease componets above
*/
